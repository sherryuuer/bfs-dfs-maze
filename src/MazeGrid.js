...
export default function MazeGrid({ width = 15, height = 15 }) {
    ...
    return (
        <div className="maze-grid">
            <div>
                <h1 className="title">Path Finding in Maze</h1>
                <p className="note">Algorithms depth first search & breadth first search Visualization in pathfinding problem. </p>
            </div>
            ...
            <p className="note">Note: Little Purple is trying to find the green door of the maze.</p>
        </div>
    );
}
